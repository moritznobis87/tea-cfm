...
ausschließlich am Day-Ahead-Markt & Intraday, FCR und aFRR sind nicht
modelliert; der ausgewiesene Speicherwert ist insoweit eine Untergrenze.
Gegenläufig wirkt die unterstellte perfekte Voraussicht -- beide Effekte
werden nicht gegeneinander aufgerechnet \\
A8b & Der Speicherbeitrag geht als Differenz zum selben Projekt ohne
Speicher in den Cashflow ein & Der bestehende Bewertungsweg über Capture
Prices bleibt unangetastet; nur so ist die Renditewirkung dem Speicher
zurechenbar \\
\end{longtable}
